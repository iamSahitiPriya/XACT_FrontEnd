...
describe('validating creating Assessment assessment popup functionality', () => {
  ...
  it('tc001 Continuous Integration and Deployment topic validation', () => {
    ...
    assessmentPage.softwareEngModuleClick(2)
    ...
    cy.fixture('DevOps').then((testData) => {
      ...
      commonFunction.typeInElement(assessmentPage.questions(1,2,1),testData[0].notes[0])
      ...
      assessmentPage.parameterMaturityScoreDesc(1,3).click().should('be.visible').contains(testData[0].CIDAssignmentMaturityScoreDesc[0])
      ...
      commonFunction.typeInElement(assessmentPage.questions(2,2,3),testData[0].notes[5])
