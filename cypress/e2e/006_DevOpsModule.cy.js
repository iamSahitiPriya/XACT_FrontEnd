 ...
 // Architectural style parameter
  it('tc001 Continuous Integration and Deployment topic validation', () => {
    ...
    cy.fixture('DevOps').then((testData) => {
      ...
      commonFunction.typeInElement(assessmentPage.notesForQuestions(12), testData[0].notes[0])
    ...
    it('tc002 Production operations topic validation', () => {
      ...
      cy.fixture('DevOps').then((testData) => {
        ...
        assessmentPage.parameterMaturityScoreDesc(1,3).click().should('be.visible').contains(testData[1].ProductionOperationsAssignmentMaturityScoreDesc[0])
