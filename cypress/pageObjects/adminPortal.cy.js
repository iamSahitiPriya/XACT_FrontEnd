...
class adminPortal {
  ...
  static tableRows(rowCount,ColCount){
    //rowCount=1,3,5,7,9....
    return cy.get('tr:nth-child('+rowCount+')>td:nth-child('+ColCount+')')
  }

  static tableHeaders(index){//action header is not included
    return cy.get('tr>th:nth-child('+index+')>div>.mat-sort-header-content')
  }
