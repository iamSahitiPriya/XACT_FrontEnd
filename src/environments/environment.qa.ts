...
export const environment = {
  production: false,
  BaseURI: "https://api-qa.xact.thoughtworks.net",
  ISSUER: '{ISSUER}',
  CLIENT_ID: '{CLIENT_ID}',
  REDIRECT_URI: "https://qa.xact.thoughtworks.net/login/callback",
  ...
  CREATE_UPDATE_DELETE_USER_QUESTION_URI:"/v1/assessments/userQuestion",
  UPDATE_USER_ANSWER_URI:"/v1/assessments/userAnswer",
